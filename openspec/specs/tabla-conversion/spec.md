# tabla-conversion Specification

## Purpose

Definir la tabla de conversión del Artículo 42 almacenada como dato y las conversiones entre porcentaje y calificación en ambos sentidos, incluida la conversión desde un puntaje sobre un máximo arbitrario.
