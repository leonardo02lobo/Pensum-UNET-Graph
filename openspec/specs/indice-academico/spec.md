# indice-academico Specification

## Purpose

Definir el cálculo del índice académico de la UNET: la nota efectiva según el Artículo 49, el índice acumulado, el redondeo del Artículo 55, las unidades de crédito aprobadas, la evaluación de compuertas contra los créditos reales y los umbrales normativos, en un módulo independiente del navegador.
