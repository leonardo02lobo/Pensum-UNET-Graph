# nota-definitiva Specification

## Purpose

Definir el cálculo de la calificación definitiva a partir del aporte ponderado de cada parcial, junto con cuánto falta para una calificación objetivo y el rango posible de la definitiva, en un módulo independiente del navegador.
