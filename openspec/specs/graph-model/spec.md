...
Definir el modelo de grafo dirigido construido desde el dataset y las consultas que expone —conos de ancestros y descendientes, orden topológico, profundidad, clasificación de aristas y búsqueda— de forma independiente del render.
