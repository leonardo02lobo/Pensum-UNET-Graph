# pensum-dataset Specification

## Purpose

Definir el dataset curado del pensum de Ingeniería en Informática de la UNET: el esquema de cada materia, las compuertas por créditos, los correquisitos, la taxonomía de sectores, la resolución documentada de discrepancias entre fuentes y la validación de integridad que lo protege.
