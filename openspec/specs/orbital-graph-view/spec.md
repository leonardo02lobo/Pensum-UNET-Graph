# orbital-graph-view Specification

## Purpose

Definir la visualización orbital 3D del pensum: el layout analítico determinista donde el radio codifica el semestre y el ángulo el sector, el tratamiento visual de compuertas y tipos de arista, la cámara orbital y los tokens de color compartidos.
